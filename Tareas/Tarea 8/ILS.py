...
def ils():
	num_nodos = 60
	num_iteraciones = 10
	lista = inst_grafo_nodos(num_nodos)
	for x in range(0,100):
		...
		#print("Beneficio" , beneficio, "Solucion: ", sol_final)
		
		tiempo_final = time()
		tiempo_ejecucion = tiempo_final - tiempo_inicial
		#print(num_iteraciones," ", num_nodos," ", beneficio," ", tiempo_ejecucion)
		print(beneficio)
		#num_nodos = num_nodos + 10
		num_iteraciones = num_iteraciones + 20
