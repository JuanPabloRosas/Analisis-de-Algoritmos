...
class Grafo:
	#TAREA 1 - REPRESENTACION Y MANIPULACION DE GRAFOS
	...
	"""	
	def lista_ady_archivo(self,path):
		lista_ady={}		
		lineas = []
		file = open(path,'r')
		for line in file:
			lineas.append(line[:-1])
		for nodos in lineas:
			nodo = 
			lista_ady[] = nodos.split
	...
	def graficar_peso(self,lista_ady):
		...
		for i in lista_ady:
			for j in lista_ady[i]:
				peso = lista_ady[i][j]
				G.add_weighted_edges_from((i,j,peso))
		
#G.add_weighted_edges_from(((0, 1, 10.0),(0, 2, 14.0),(0, 3, 12.0),(1, 2, 8.0),(1, 4, 19.0),(2, 3, 7.0),(2, 5, 22.0),(3, 5, 21.0),(4, 5, 11.0)))	
